...
export default function Oferta() {
  return (
    <section className="relative flex flex-col lg:flex-row items-center justify-center bg-gradient-to-b from-[#1a1a1a] via-[#121212] to-[#0f0f0f] text-white px-6 lg:px-12 py-12">
      ...
      <div className="bg-white text-gray-900 p-8 lg:p-14 rounded-3xl shadow-lg max-w-md lg:max-w-xl min-h-[400px] flex flex-col justify-between relative z-10 px-4">
        <h2 className="text-4xl font-bold text-center mb-4">
          Tudo isso por apenas
        </h2>

        <div className="flex justify-center items-end mt-2">
          <span className="flex items-start text-6xl font-bold">
            <span className="text-3xl mr-1">12x</span>R$
          </span>
          <span className="text-8xl font-extrabold text-[#05D8FF]">33</span>
          <span className="text-7xl font-semibold text-[#05D8FF]">,33</span>
        </div>
