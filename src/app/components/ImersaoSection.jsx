...
const ImersaoSection = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-[#e5e5e5] to-[#F5F5F5] py-16 px-6 sm:px-8 text-center">
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#0f0f0f] uppercase">
      ...
      <button
        ...
        className="mt-8 uppercase bg-gradient-to-b from-[#05D8FF] to-[#2B67DF] hover:from-[#09D9E0] hover:to-[#2A66DE] text-white font-semibold px-6 sm:px-12 md:px-24 py-3 rounded-full focus:outline-none transition duration-300 transform hover:scale-105 animate-scale shadow-lg"
      >
