export default function MentoraSection() {
  return (
    <section className="relative w-full bg-gradient-to-b from-[#e5e5e5] to-[#F5F5F5] flex items-center justify-center">
      <div className="container mx-auto px-4 sm:px-8 flex flex-col lg:flex-row items-center justify-center gap-8 lg:-mt-40">
        {/* Texto */}
        <div className="lg:w-1/2 flex flex-col justify-center items-center lg:items-start text-center lg:text-left">
          <h2 className="text-xl mt-14 sm:text-3xl lg:text-4xl font-bold text-[#009ACF] mb-4">
            Conheça sua mentora
          </h2>
